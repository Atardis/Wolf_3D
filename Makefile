...
SRC =	image_wolf3d.c main.c map.c print_wall_wolf.c trace_line.c\
		trace_line_angle.c trace_line_verif.c trace_wall.c wolf_color.c\
		wolf_hypotenuse.c other.c move_wolf3d.c
